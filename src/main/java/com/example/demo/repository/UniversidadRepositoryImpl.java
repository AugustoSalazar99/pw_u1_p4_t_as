...
public class UniversidadRepositoryImpl implements IUniversidadRepository {
	...
	public List<Universidad> seleccionarInnerJoin() {
		...
		TypedQuery<Universidad> myQuery=this.entityManager.createQuery(
				"SELECT u FROM Universidad u INNER JOIN u.empleado e"
				, Universidad.class);
	...
	public List<Universidad> seleccionarOuterRightJoin() {
		// TODO Auto-generated method stub
		TypedQuery<Universidad> myQuery=this.entityManager.createQuery(
				"SELECT u FROM Universidad u RIGHT JOIN u.empleado e"
				, Universidad.class);
		return myQuery.getResultList();
	}
	...
	public List<Universidad> seleccionarOuterLeftJoin() {
		// TODO Auto-generated method stub
		TypedQuery<Universidad> myQuery=this.entityManager.createQuery(
				"SELECT u FROM Universidad u LEFT JOIN u.empleado e"
				, Universidad.class);
		return myQuery.getResultList();
	}
	...
	public List<Universidad> seleccionarUniversidadOuterFulltJoin() {
		// TODO Auto-generated method stub
		TypedQuery<Universidad> myQuery=this.entityManager.createQuery(
				"SELECT u FROM Universidad u FULL OUTER JOIN u.empleado e",
				Universidad.class);
		return null;
	}
